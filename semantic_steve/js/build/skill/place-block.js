...
exports.PlaceBlock = exports.PlaceBlockResults = void 0;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (!this.inventoryItem) {
                    this.isPlacing = false;
                    return this.onResolution(new PlaceBlockResults.BlockNotInInventory(block));
                }
                ...
                if (this.targetPosition) {
                    return this.onResolution(new PlaceBlockResults.FailureNoAdjacentBlocks(block, `${this.targetPosition.x}, ${this.targetPosition.y}, ${this.targetPosition.z}`));
                }
                else {
                    return this.onResolution(new PlaceBlockResults.BlockNotInInventory(block));
                }
    ...
    resume() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.isPlacing && this.blockId !== -1 && this.targetPosition) {
                ...
                this.inventoryItem = this.bot.inventory.items().find(item => item.name === this.blockName ||
                    (item.name === this.blockName + '_block') ||
                    (this.blockName === item.name + '_block'));
                if (!this.inventoryItem) {
                    return this.onResolution(new PlaceBlockResults.BlockNotInInventory(this.blockName));
                }
                this.isPlacing = true;
                return this.doPlacing();
            }
    ...
    doPlacing() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!targetBlock) {
                    this.isPlacing = false;
                    return this.onResolution(new PlaceBlockResults.FailureNoAdjacentBlocks(this.blockName, `${this.targetPosition.x}, ${this.targetPosition.y}, ${this.targetPosition.z}`));
                }
                ...
                this.isPlacing = false;
                return this.onResolution(new PlaceBlockResults.Success(this.blockName, `${this.targetPosition.x}, ${this.targetPosition.y}, ${this.targetPosition.z}`));
            }
            catch (error) {
                console.error(`Error in doPlacing:`, error);
                this.isPlacing = false;
                return this.onResolution(new PlaceBlockResults.FailureNoAdjacentBlocks(this.blockName, this.targetPosition ? `${this.targetPosition.x}, ${this.targetPosition.y}, ${this.targetPosition.z}` : "unknown"));
            }
        });
    }
}
