...
const itemEntity_1 = require("../../thing/itemEntity");
    ...
    invoke(itemName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const itemEntity = this.bot.thingFactory.createThing(itemName, itemEntity_1.ItemEntity);
                // Ensure the item is actually an ItemEntity
                if (!(itemEntity instanceof itemEntity_1.ItemEntity)) {
