    ...
    invoke(block_1) {
        return __awaiter(this, arguments, void 0, function* (block, quantity = 1) {
            ...
            try {
                ...
                this.blockPositions = (0, utils_1.findBlocksOfType)(this.bot, block);
                if (this.blockPositions.length === 0) {
                    this.isMining = false;
                    return this.onResolution(new results_1.MineBlocksResults.BlockNotInSurroundings(block));
                }
    ...
    doMining() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                    ...
                    if (blockToMine.name === this.blockToMine) {
                        try {
                            ...
                            if (this.currentQuantity < this.targetQuantity &&
                                ...
                                const newBlocks = (0, utils_1.findBlocksOfType)(this.bot, this.blockToMine);
                ...
                this.isMining = false;
                if (this.currentQuantity === 0) {
                    return this.onResolution(new results_1.MineBlocksResults.BlockNotInSurroundings(this.blockToMine));
                }
