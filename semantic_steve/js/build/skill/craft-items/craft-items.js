    ...
    doCrafting() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.isCrafting = false;
                return this.onResolution(new results_1.CraftItemsResults.Success(this.craftItem, this.craftQuantity));
            }
            catch (error) {
                // Handle unexpected errors
                console.error(`Error in doCrafting:`, error);
                this.isCrafting = false;
                return this.onResolution(new results_1.CraftItemsResults.InsufficientRecipeIngredients(this.craftItem, this.craftQuantity));
            }
        });
    }
    /**
