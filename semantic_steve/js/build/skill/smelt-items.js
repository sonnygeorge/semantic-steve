...
exports.SmeltItems = exports.SmeltItemsResults = void 0;
...
class SmeltItems extends skill_1.Skill {
    ...
    doSmelting(itemToSmelt, fuelItem) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.isSmelting = false;
                if (this.smeltedQuantity >= this.targetQuantity) {
                    this.onResolution(new SmeltItemsResults.Success(this.itemToSmelt, this.smeltedQuantity, this.resultItem, this.resultQuantity));
                }
                else if (this.smeltedQuantity > 0) {
                    this.onResolution(new SmeltItemsResults.PartialSuccess(this.itemToSmelt, this.smeltedQuantity, this.targetQuantity, this.resultItem, this.resultQuantity));
                }
                else {
    ...
    handleError(error) {
        ...
        if (this.smeltedQuantity > 0) {
            this.onResolution(new SmeltItemsResults.PartialSuccess(this.itemToSmelt, this.smeltedQuantity, this.targetQuantity, this.resultItem || "unknown", this.resultQuantity));
        }
        else {
            this.onResolution(new SmeltItemsResults.NoFurnaceEtc(this.itemToSmelt));
        }
    ...
    findSuitableFuel() {
        return this.bot.inventory.items().find(item => ['coal', 'charcoal', 'coal_block'].includes(item.name) ||
