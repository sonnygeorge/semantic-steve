// ========================================================================================
// NOTE: The following utils were generated by Claude on Apr 23, 2025 using the table from
 ...
 */
export function getSmeltingProductName(itemName: string): string | undefined {
  // Convert to lowercase for case-insensitive matching
  const item = itemName.toLowerCase();

  // Food items
  if (item === "potato") return "baked_potato";
  if (item === "kelp") return "dried_kelp";
  if (item === "raw_beef") return "cooked_beef";
  if (item === "raw_porkchop") return "cooked_porkchop";
  if (item === "raw_mutton") return "cooked_mutton";
  if (item === "raw_chicken") return "cooked_chicken";
  if (item === "raw_rabbit") return "cooked_rabbit";
  if (item === "raw_cod") return "cooked_cod";
  if (item === "raw_salmon") return "cooked_salmon";

  // Raw materials to ingots
  if (item === "raw_iron") return "iron_ingot";
  if (item === "raw_copper") return "copper_ingot";
  if (item === "raw_gold") return "gold_ingot";
  if (item === "ancient_debris") return "netherite_scrap";

  // Metal blocks to ingots (added)
  if (item === "iron_block") return "iron_ingot";
  if (item === "gold_block") return "gold_ingot";
  if (item === "copper_block") return "copper_ingot";

  // Ores to materials
  if (item.includes("redstone_ore")) return "redstone";
  if (item.includes("coal_ore")) return "coal";
  if (item.includes("emerald_ore")) return "emerald";
  if (item.includes("lapis_lazuli_ore") || item.includes("lapis_ore"))
    return "lapis_lazuli";
  if (item.includes("diamond_ore")) return "diamond";
  if (item === "nether_quartz_ore") return "quartz";
  if (item.includes("iron_ore")) return "iron_ingot";
  if (item.includes("copper_ore")) return "copper_ingot";
  if (item.includes("gold_ore") || item === "nether_gold_ore")
    return "gold_ingot";

  // Tools and armor to nuggets
  if (
    (item.includes("iron_") || item.includes("chainmail_")) &&
  ...
  // Stone materials
  if (item === "cobblestone") return "stone";
  if (item === "stone") return "smooth_stone";
  if (item === "stone_bricks") return "cracked_stone_bricks";
  if (item === "cobbled_deepslate") return "deepslate";
  if (item === "deepslate_bricks") return "cracked_deepslate_bricks";
  if (item === "deepslate_tiles") return "cracked_deepslate_tiles";
  if (item === "sandstone") return "smooth_sandstone";
  if (item === "red_sandstone") return "smooth_red_sandstone";
  if (item === "nether_bricks") return "cracked_nether_bricks";
  if (item === "basalt") return "smooth_basalt";
  if (item === "polished_blackstone_bricks")
    return "cracked_polished_blackstone_bricks";
  if (item === "quartz_block") return "smooth_quartz";

  // Other materials
  if (item === "clay") return "terracotta";
  if (item === "sand") return "glass";
  if (item === "red_sand") return "glass";
  if (item === "wet_sponge") return "sponge";
  if (item === "chorus_fruit") return "popped_chorus_fruit";
  if (item === "sea_pickle") return "lime_dye";
  if (item === "cactus") return "green_dye";
  if (item === "clay_ball") return "brick";
  if (item === "netherrack") return "nether_brick";
