...
HEALPIX_HASH_SAVE_FILE_PATH = os.path.join(_PATH_TO_THIS_FILE_DIR, "../", "healpix_hash.json")
HEALPIX_HASH_SAVE_FILE_PATH_ENV_VAR_NAME = "SEMANTIC_STEVE_HEALPIX_HASH_SAVE_FILE_PATH"
