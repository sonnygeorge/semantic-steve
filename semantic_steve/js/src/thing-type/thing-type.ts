...
export interface ThingType {
  ...
  isVisibleInImmediateSurroundings(): MaybePromise<boolean>;

  isVisibleInDistantSurroundings(): MaybePromise<boolean>;
  ...
  isVisibleInImmediateSurroundingsAt(coords: Vec3): MaybePromise<boolean>;
}
