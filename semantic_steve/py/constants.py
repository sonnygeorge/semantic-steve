...
DEFAULT_PRECOMPUTED_RAYCAST_DATA_FPATH = os.path.join(_PATH_TO_THIS_FILE_DIR, "../", "precomputed_raycast_data.json")
PRECOMPUTED_RAYCAST_DATA_FPATH_ENV_VAR_NAME = "SEMANTIC_STEVE_PRECOMPUTED_RAYCAST_DATA_FPATH"
DEFAULT_DISTANT_SURROUNDINGS_RADIUS = 25  # Default radius for distant surroundings in blocks
DISTANT_SURROUNDINGS_RADIUS_ENV_VAR_NAME = "SEMANTIC_STEVE_DISTANT_SURROUNDINGS_RADIUS"