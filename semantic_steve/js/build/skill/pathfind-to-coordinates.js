...
class PathfindToCoordinates extends skill_1.Skill {
    ...
    getResultIfAnyStopIfFoundThingInSurroundings() {
        ...
        for (const thing of this.stopIfFound) {
            if (thing.isVisibleInImmediateSurroundings()) {
                return new skill_results_1.PathfindToCoordinatesResults.FoundThingInImmediateSurroundings(this.targetCoords, thing.name);
            }
            else if (thing.isVisibleInDistantSurroundings()) {
                return new skill_results_1.PathfindToCoordinatesResults.FoundThingInDistantSurroundings(this.targetCoords, thing.name);
            }
        }
    }
    // ====================
    ...
    resolveInvalidCoords(coords) {
        ...
        this.onResolution(new skill_results_1.PathfindToCoordinatesResults.InvalidCoords(coords));
    }
    resolveInvalidThing(thingName) {
        console.log("Resolving pathfinding as invalid thing");
        const result = new skill_results_1.PathfindToCoordinatesResults.InvalidThing(thingName, thing_1.SUPPORTED_THING_TYPES);
    ...
    resolvePathfindingPartialSuccess() {
        ...
        (0, assert_1.default)(this.targetCoords);
        this.cleanupListeners();
        const result = new skill_results_1.PathfindToCoordinatesResults.PartialSuccess(this.bot.entity.position, this.targetCoords);
        this.unsetPathfindingParams();
        this.onResolution(result);
    }
    resolvePathfindingSuccess() {
        ...
        const result = (_a = this.getResultIfAnyStopIfFoundThingInSurroundings()) !== null && _a !== void 0 ? _a : new skill_results_1.PathfindToCoordinatesResults.Success(this.targetCoords);
        this.unsetPathfindingParams();
    ...
    invoke(coords, stopIfFound) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.targetCoords = new vec3_1.Vec3(coords[0], coords[1], coords[2]);
